...
namespace UnityRoyale
{
    public class HealthBar : MonoBehaviour
    {
        ...
        public void Initialise(ThinkingPlaceable p)
        {
            ...
            wholeWidget.transform.localPosition = new Vector3(0f, (p.pType == Placeable.PlaceableType.Unit) ? 2f : 6f, 0f); //set the vertical position based on the type of Placeable
